      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-teal-600 to-emerald-800 relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <p className="text-emerald-100 text-lg leading-relaxed">
            Your AI-powered nutrition coach. Snap, analyze, and transform your health journey.
          </p>
          <div className="mt-10 grid grid-cols-3 gap-4 text-center">
            {[{ val: 'AI', label: 'Powered' }, { val: '24/7', label: 'Available' }, { val: 'Free', label: 'Forever' }].map(s => (
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input type={showPw ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} required
                      className="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:outline-none input-enhanced pr-12 text-gray-900" placeholder="Enter your password" />
                ...
                <button type="submit" disabled={loading}
                  ...
                  {loading ? <><Loader2 className="w-5 h-5 animate-spin" /> Signing in...</> : <>Sign In <ArrowRight className="w-4 h-4" /></>}
                </button>
              </form>

              <p className="text-center text-gray-500 mt-6 text-sm">
                New here?{' '}<Link href="/register" className="text-emerald-600 font-semibold hover:text-emerald-500 transition-colors">Create free account</Link>
              </p>
            </div>
          </div>
        </div>
